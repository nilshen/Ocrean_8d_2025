...
export const Monster = class Monster {
    constructor() {
        this.radius = 50;
        ...
        if (posMonster > 6) {
            ...
            const randomL = Math.floor(Math.random() * 2 + 1);
            switch (randomL) {
                case 1:
                    this.image = m11;
                    break;
            ...
            const randomR = Math.floor(Math.random() * 2 + 1);
            switch (randomR) {
                case 1:
                    this.image = m33;
                    break;
...
export const flowMonster = (flowMonster) => {
